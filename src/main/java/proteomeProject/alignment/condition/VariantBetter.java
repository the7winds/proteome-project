 ...
 */
public class VariantBetter implements Condition {

    private final static String OUTPUT = "compare(var better than std)";
    ...
    public VariantBetter() throws FileNotFoundException {
    ...
    public void addIf(Annotation annotation) {
        ...
        if (stdAnnotation != null) {
            if (Utils.greater(annotation, stdAnnotation, 1)) {
